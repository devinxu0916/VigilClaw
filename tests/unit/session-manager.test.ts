...
describe('SessionManager', () => {
  ...
  it('should return empty context for new session', () => {
    const ctx = session.getContext('u1');
    expect(ctx).toHaveLength(0);
  });

  it('should save and retrieve user messages', () => {
